...
namespace LowPolyUnderwaterPack
{
    ...
    public class PlantCoralAnimation : MonoBehaviour
    {
        ...
        private void UpdatePropBlock(float rand)
        {
            ...
            // Custom coral property texturing
            // Set texture offset if using coral properties, revert to default texture offset if not using coral properties
    ...
    {
        private SerializedProperty tint, showCoralProperties, materialTextureOffset, visualizeWaveGradient, waveLength, waveSpeed, waveHeight, gradientBlending, gradientOffset, 
